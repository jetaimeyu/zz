...
<div class="panel panel-default col-sm-6">
    <div class="panel-body">
        ...
        <form class="form-inline pull-right" method="get" action="<?=Url::to(['link']);?>">
            <a href="<?=Url::to(['link']);?>" class="btn btn-success btn-sm"><span class="fa fa-fw fa-plus"></span> 新增友情链接</a>
        </form>
    </div>
    <div class="panel-body">
        <table class="table table-hover">
            <tr>
                <th class="text-left">友情链接名称</th>
            ...
            <tr class="data-tr">
                ...
                <td class="text-center middle" style="line-height:34px;">
                    <a href="<?=Url::to(['link', 'id'=>$m->id])?>" class="btn btn-success btn-sm"><span class="fa fa-pencil fa-fw"></span> 编辑</a>
                    <a href="<?=Url::to(['delete', 'id'=>$m->id])?>" class="delete-btn btn btn-danger btn-sm confirmLink" confirmMessage="确定要删除友情链接“<?=$m->name;?>”吗？"><span class="fa fa-trash-o fa-fw"></span> 删除</a>
                </td>
            </tr>
            <?php endforeach;?>
            <?php else:?>
...
<div class="col-sm-6">
    <div class="panel panel-default" style="padding:15px 0px;">
        ...
        <?= $form->field($model, 'url', ['horizontalCssClasses' => ['wrapper' => 'col-sm-6']])->textInput(['maxlength' => true, 'class'=>'form-control input-sm']); ?>
        ...
        <div class="form-group">
            <div class="col-sm-offset-2 col-sm-6">
                <?= Html::submitButton($model->isNewRecord ? '增加友情链接' : '编辑友情链接', ['class' => 'btn btn-sm ' . ($model->isNewRecord ? 'btn-success' : 'btn-primary')]) ?>
            </div>
        </div>
        <?php ActiveForm::end(); ?>
    </div>
